...
colum_date = FOREACH data GENERATE date,
...
colum_date_string = FOREACH colum_date GENERATE date, x, y, SUBSTRING(dia,0, 3), dia;

STORE colum_date_string INTO 'output' USING PigStorage(',');
